...
public class UpdateProfileActivity extends AppCompatActivity {
   ...
   String newname;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mtoolbarofupdateprofile=findViewById(R.id.tool_bar_of_update_profile);
        mbackbuttonofupdateprofile=findViewById(R.id.back_button_of_update_profile);
        mgetnewimageinimageview=findViewById(R.id.get_new_user_image_in_imageview);
        mprogressbarofupdateprofile=findViewById(R.id.progress_bar_of_update_profile);
        mnewusername=findViewById(R.id.get_new_username);
